...
<body>
   ...
   <a href="/user5/1.JDBCTest.jsp">처음으로</a>
   <a href="/user5/user5/list.jsp">목록</a>
   
   <form action="/user5/user5/modifyProc.jsp" method="post">
      <table border="1">
         <tr>
            <td>아이디</td>
            <td><input type="text" name="uid" value="<%= vo.getSeq() %>" readonly/></td>
         </tr>
         <tr>
            <td>이름</td>
